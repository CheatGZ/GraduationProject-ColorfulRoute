...
public class UpdateHeight extends BaseActivity {
    UpdateHeight self = this;
            ...
            switch (v.getId()) {
                ...
                case R.id.right_layout:
                    if (inputText.getText().toString().equals("") || Integer.parseInt(inputText.getText().toString()) == 0) {
                        ...
                        userInfo.setHeight(Integer.parseInt(inputText.getText().toString()));
