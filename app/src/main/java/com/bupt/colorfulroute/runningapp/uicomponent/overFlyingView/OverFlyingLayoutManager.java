package com.bupt.colorfulroute.runningapp.uicomponent.overFlyingView;
...
public class OverFlyingLayoutManager extends RecyclerView.LayoutManager {
    ...
    private void calculateChildrenSiteVertical(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        Log.d(TAG, "childCountIv = " + getChildCount() + "  itemCount= " + recycler.getScrapList().size());
    }
    ...
    private void calculateChildrenSiteHorizontal(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        Log.d(TAG, "childCountIh = " + getChildCount() + "  itemCount= " + recycler.getScrapList().size());
    }
    ...
    private void addAndLayoutViewVertical(RecyclerView.Recycler recycler, RecyclerView.State state, int offset) {
        ...
        index=offset;
        Log.d(TAG,"offsetJv=  "+offset);
        Log.d(TAG, "childCountJv = " + getChildCount() + "  itemCount= " + itemCount);
    }

    private void addAndLayoutViewHorizontal(RecyclerView.Recycler recycler, RecyclerView.State
            state, int offset) {
        int itemCount = getItemCount();
        if (itemCount <= 0 || state.isPreLayout()) {
            return;
        ...
        index=offset;
        Log.d(TAG,"offsetJh=  "+offset);
        Log.d(TAG, "childCountJh = " + getChildCount() + "  itemCount= " + itemCount);
    }
